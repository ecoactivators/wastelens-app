    ...
    try {
      ...
      const requestBody = {
        ...
        messages: [
          {
            role: 'system',
            content: `You are an expert waste analysis AI for Tesla Trash™. Your mission is to route items AWAY from landfills whenever possible. Analyze the image and provide smart disposal guidance.
...
ELECTRONICS → Best Buy, Staples electronics recycling
PLASTIC FILM → Grocery store plastic film recycling bins  
CHIP BAGS & MULTI-MATERIAL LAMINATES → General waste bin (metallized layers can't be separated)
HAZARDOUS ITEMS → Household hazardous waste facilities
TEXTILES → Donation centers, textile recycling
CERAMICS → Goodwill, school art classes, Habitat ReStore, C&D Recovery
ORGANIC WASTE → Compost bins or community sites
STANDARD RECYCLABLES → Regular recycling bin
...
Make your suggestions specific and actionable. Always try to route items to their best disposal method rather than defaulting to landfill. Give direct instructions without using any form of "check" or "verify".`
          },
          {
            role: 'user',
            content: [
